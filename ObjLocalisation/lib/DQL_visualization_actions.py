...
def visualizing_seq_act(model_name, add, ground_truth, output_name):
    ...
    with tf.Session() as sess:
        ...
        # Keeps going until the agent could successfully localize an object
        while final_reward != 3:
            ...
            # The agent searches in an image until termination action is used or the agent reaches threshold 50 actions
